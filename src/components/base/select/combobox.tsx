...
interface ComboBoxProps extends Omit<AriaComboBoxProps<SelectItemType>, "children" | "items">, RefAttributes<HTMLDivElement>, CommonProps {
    ...
    popoverBoundaryElement?: Element;
...
const ComboBoxValue = ({ size, shortcut, placeholder, shortcutClassName, triggerClassName, icon: IconProp, ...otherProps }: ComboBoxValueProps) => {
            ...
            <AriaComboBox menuTrigger="focus" {...otherProps}>
                {(state) => (
                    <div className="flex flex-col gap-1.5">
                        {otherProps.label && (
                            <Label isRequired={hideRequiredIndicator ? false : state.isRequired} tooltip={otherProps.tooltip} className={labelClassName}>
                                {otherProps.label}
                            </Label>
                        )}
                        ...
                        <Popover
                            ...
                            boundaryElement={popoverBoundaryElement}
                        >
