      ...
      >
        ...
        <div className="flex skew-x-12 items-center gap-2">
          ...
          <input
            ...
            className="min-w-0 flex-1 font-quantify bg-transparent px-1.5 py-2 text-sm text-zinc-900 outline-none placeholder:text-zinc-400 dark:text-zinc-100 dark:placeholder:text-zinc-500"
