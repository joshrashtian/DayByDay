          ...
          <div className="mb-6 rounded-2xl border border-line/60 bg-surface/45 p-4 shadow-sm ring-1 ring-line/40 backdrop-blur-xl">
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-ink px-4 py-2.5 text-sm font-semibold text-white hover:bg-ink"
              >
                  ...
                  >
                    <div className="flex flex-wrap items-center gap-3 p-4">
                      <Link
                        ...
                        className="flex min-w-0 flex-1 items-center gap-3 rounded-xl transition-colors hover:bg-surface/40"
                      >
                        <span
