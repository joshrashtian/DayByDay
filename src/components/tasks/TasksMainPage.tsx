    ...
    <>
      ...
      <header className="shrink-0 px-5 pb-2 pt-2 sm:px-8">
        <div className="mx-auto flex w-full max-w-3xl items-end justify-between gap-3 xl:max-w-4xl">
          ...
          <Link
            to="/tasks/categories"
            className="inline-flex items-center gap-1.5 rounded-full border border-line/70  px-3 py-1.5 text-xs font-semibold text-muted ring-1 ring-line/30 backdrop-blur-xl transition-colors hover:bg-surface/80"
          >
