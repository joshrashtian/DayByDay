...
export const taskPopupField = {
  label:
    "text-sm font-semibold uppercase font-quantify text-zinc-500 dark:text-zinc-400",
  sectionTitle:
    "text-base font-bold uppercase font-quantify text-zinc-400 dark:text-zinc-500",
  input:
    "w-full rounded-xl  bg-white/90 px-3.5 py-2.5 text-sm text-zinc-900 border border-zinc-200/90 outline-none placeholder:text-zinc-400 focus:border-zinc-400 focus:ring-2 focus:ring-zinc-300/35 dark:border-zinc-600/90 dark:bg-zinc-950/65 dark:text-zinc-50 dark:placeholder:text-zinc-500 dark:focus:border-zinc-500 dark:focus:ring-zinc-600/35",
  selectLabel:
    "text-sm font-semibold uppercase font-quantify text-zinc-500 dark:text-zinc-400",
  selectTrigger:
  ...
  panel:
    "py-4 border-b border-zinc-200 dark:border-zinc-700",
  weekdayActive:
